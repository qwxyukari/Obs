...
do
    ...
    ThemeManager.BuiltInThemes = {
        ["Default"] = {
            1,
            { FontColor = "ffffff", FontFace = "Gotham", MainColor = "191919", AccentColor = "#90a8ff", BackgroundColor = "0f0f0f", OutlineColor = "282828" },
        },
        ["BBot"] = {
            2,
    ...
    function ThemeManager:CreateThemeManager(groupbox)
        ...
        groupbox:AddDropdown("FontFace", {
            Text = "Font Face",
            Default = "Gotham",
            Values = { "Gotham", "GothamMedium", "GothamBold", "BuilderSans", "BuilderSansMedium", "JosefinSans", "JosefinSansLight", "Jura" },
        })
